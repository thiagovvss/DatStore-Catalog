 ...
 return (
   <ScrollView style={styles.container}>
    ...
    <View>
      ...
      <View opacity={0.4}>
        <Text style={[styles.title, {fontSize:35}]}> IPHONE 15 PRO MAX 128GB </Text>
      </View>
  
      <View>
        <Text style={[styles.title, {fontSize:25}]}> R$6990,00 </Text>
      </View>
